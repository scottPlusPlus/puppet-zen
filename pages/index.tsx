...
export default function Home() {
  return (
    <>
      ...
      >
        ...
        <p>
          A Next.js API service to convert URLs to PDF files with optional
          authorization.
        </p>
  ...
  --output example.pdf`}
        ...
        <p>
          Advanced PDF generation with custom styling, page breaks, and broken
          image handling.
        </p>
  ...
  --output my-report.pdf`}
        ...
        <h2>🔐 Authorization</h2>
        <p>
          Authorization is <strong>optional</strong> and controlled by the{" "}
          <code>PUPPETEER_GEN_USER</code> environment variable.
        </p>

        <h3>How It Works</h3>
        <ul style={{ marginLeft: "20px" }}>
          <li>
            If <code>PUPPETEER_GEN_USER</code> is not set or empty → No
            authorization required
          </li>
          <li>
            If <code>PUPPETEER_GEN_USER</code> is set → Authorization required
            for all PDF endpoints
          </li>
        </ul>
        ...
        <p>
          Include the API key in the <code>Authorization</code> header with{" "}
          ...
          <tbody>
            <tr>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                <code>PUPPETEER_GEN_USER</code>
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Optional
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Comma-separated API keys for authorization (format: key:name)
              </td>
            </tr>
            <tr>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                <code>PUPPETEER_EXECUTABLE_PATH</code>
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Optional
              </td>
            ...
            <tr>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                <code>GRAFANA_LOKI_HOST</code>
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Optional
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Grafana Loki host for logging
              </td>
            </tr>
            <tr>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                <code>GRAFANA_LOKI_USERNAME</code>
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Optional
              </td>
            ...
            <tr>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                <code>GRAFANA_LOKI_PASSWORD</code>
              </td>
              <td style={{ padding: "10px", border: "1px solid #ddd" }}>
                Optional
              </td>
